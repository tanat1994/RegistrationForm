(function(h) {
    ...
    function ob(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" id="searchinput" class="' + b.sFilterInput + '"/>',
            j = d.sSearch,
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: {
                ...
                sPrevious: "{{trans('table.previous')}} "
            },
            ...
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "{{ trans('table.show') }} _MENU_ {{ trans('table.entries') }}",
            sLoadingRecords: "Loading...",
            sProcessing: "Processing...",
            sSearch: "{{trans('table.search')}}",
            sSearchPlaceholder: "{{ trans('table.searchplaceholder') }}",
            sUrl: "",

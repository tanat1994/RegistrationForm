                                ...
                                <div class="col-md-12"></h1>
                                    ...
                                    {!! csrf_field() !!}
                                        ...
                                        <script>
                                            ...
                                            //             $.post("http://127.0.0.1/Registrationform/public/index.php/testpage", response["data"])
                                            //             .done(function (data){
                                            ...
                                            //             //     var result = [];
                                            //             //     result.push(item.PtnId);
                                            //             //     result.push(item.StdCode);
                                            //             // });
                                            //             // $('#myTable').DataTable().row.add(result);



                                            //             // $.each(response["data"], function (index, value){
                                            //             //     console.log(value["PtnId"]);
                                            //             //     $('#bodyTable').append("<tr><td>"+value["PtnId"]+"</td></tr>");
                                            //             // });
                                            //             // $('#bodyTable>tr>td').remove();   
                                            //         },
                                            //         error : function(){
                                            //             alert("ERROR");
                                            //         }
                                            ...
                                            //         success : function(response){
                                            //             // $.ajax({
                                            //             //     url : 'http://127.0.0.1/Registrationform/public/index.php/membersearchandfilter',
                                            //             //     type : 'post',

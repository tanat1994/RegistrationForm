...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <input type="hidden" id="path_public" name="path_public" value="";/>
            <!-- 1st HEADER -->
            <div class="col-md-12">
                <h2 style="color:;;"><a href="{{ URL::to('/membermanagement') }}" style="text-decoration:none;color:;;"><strong>{{ trans('menu.member') }}</a>  >  {{ trans('register.register') }}</strong></h2>
                                                ...
                                                <div class="form-group row" style="position:relative;">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            ...
                                                            <span class="input-group-btn">
                                                                <input type="button" onclick="search_vis_data();" class="form-control btn input-lg" id="vis_cardId_search" name="vis_cardId_search" value="{{trans('register.search')}}" style="font-size:20px;background-color:;;color:white;">

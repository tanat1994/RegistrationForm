                    ...
                    {{-- Member Management Tabpills--}}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table>
                                        ...
                                        <!-- <tr id="filter_col6" data-column="10"> -->
                                            <td style="width: 160px;">
                                                <label for="filter_degree">DEGREE : </label>
                        ...
                        <script>
                            ...
                            function degreeOnSelect () {
                                ...
                                var degreeText = $('#col10_filter :selected').text();
                                if(degreeText == "Show all"){ degreeText = ""; }
                            ...
                            function facultyOnSelect () {
                                ...
                                var facultyText = $('#col12_filter :selected').text();
                            ...
                            function statusOnSelect () {
                                ...
                                var statusText = "(( )|^)" + document.getElementById('col16_filter').value + "(( )|$)"
